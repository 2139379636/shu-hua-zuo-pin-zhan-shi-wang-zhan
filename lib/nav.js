    ...
    host.innerHTML = `
      <div class="nav__inner">
        ...
        <ul class="nav__menu">
          ...
          <li><a href="gallery.html" class="nav__link ${isActive('gallery.html') ? 'nav__link--active' : ''}">全部作品</a></li>
          <li><a href="artist.html#selected" class="nav__link ${isActive('artist.html') && location.hash === '#selected' ? 'nav__link--active' : ''}">十年精选</a></li>
          <li><a href="artist.html"  class="nav__link ${isActive('artist.html') && location.hash !== '#selected' ? 'nav__link--active' : ''}">艺术家</a></li>
        </ul>
      </div>
    `;
